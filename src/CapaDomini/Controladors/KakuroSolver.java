...
public class KakuroSolver {
    ...
    /**@brief Nombre de solucions trobades pel solver */
    int numSolucions;
    ...
    */
    ...
    /** @brief Consulta el nombre de solucions del kakuro.
        @pre S'ha cridat al solver de la classe.
        @post S'ha retornat el nombre de solucions del kakuro.
    */
    ...
    */
    public boolean solucio(boolean check) {
        ...
        if(!taulell.CheckTaulellValidEstructuralment()) return false;
    ...
    private void setTaulellSolucio() {
        for (int i = 0; i < files; i++) {
            for (int j = 0; j < columnes; j++) {
                taulell.setValorSolucio(i,j, taulell.getValorCasella(i, j));
            }  
        }
    }
